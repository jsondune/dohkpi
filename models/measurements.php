...
class Measurement extends \yii\db\ActiveRecord
{
    ...
    const FILE_PATH = '/dohkpi/web/uploads/';
    ...
    public function rules()
    {
        return [
            ...
            [['user_id'], 'integer'],
            [['birth_date', 'notes', 'tag'], 'safe'],
            [['prefix_name','gender','person_type','job_title','office','department','province','activate_status'],'string'],
    ...
    public function behaviors() {
        return [
            ...
            [
                ...
                'attributes' => [
                    ActiveRecord::EVENT_BEFORE_INSERT => 'tag',
                    ActiveRecord::EVENT_BEFORE_UPDATE => 'tag',
                ],
    ...
    {
        return $this->hasMany(Measurement::className(), ['subscriber_id' => 'id']);
    }
    ...
    public function uploadPhoto($file_photos)
    {
        if ($this->validate()) {
            ...
            // Development Path (http://SERVER_NAME/dohkpi-yii2)
            $file_path = '/xampp/htdocs/dohkpi-yii2/web/uploads/';
            //
    ...
    public function getUploadedPhotoHtml() {
        ...
        //return Yii::getAlias('@webroot') . '/uploads/' . $this->photo;
        //return Yii::getAlias('@appRoot') . '/uploads/' . $this->photo;      
        return (($this->photo!="") ? Html::a(($this->photo), (Measurement::FILE_PATH.$this->photo), ['target' => '_blank']) : "");
    }
    ...
    public function getUploadedMultiplePhoto() {
        ...
        $file_path = '/dohkpi-yii2/web/uploads/';
